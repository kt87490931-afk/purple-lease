...
(function () {
  ...
  function unpackHeroButtonsState(raw, fallbackLink) {
    ...
    if (Array.isArray(raw)) {
      ...
      if (raw[0] && raw[0].bg_image_url_mobile) bgMobile = String(raw[0].bg_image_url_mobile || '').trim();
      ...
      bgMobile = String(raw.bg_image_url_mobile || '').trim();
    }
    return { zone: zone, link_url: link, items: items, bg_image_url_mobile: bgMobile };
  }

  function packHeroButtonsState(buttons, ctaZone, linkUrl, bgMobile) {
    ...
    return {
      ...
      bg_image_url_mobile: String(bgMobile || '').trim(),
      items: items
    };
  }
  ...
  async function listHeroSlides() {
    ...
    return (res.data || []).map(function (row) {
      ...
      row.bg_image_url_mobile = packed.bg_image_url_mobile;
      return row;
    });
  }
  ...
  async function saveHeroSlide(payload, editingId) {
    ...
    var bgMobile = String(payload.bg_image_url_mobile || '').trim();
    var row = {
      is_enabled: payload.is_enabled !== false,
      ...
      buttons: packHeroButtonsState(payload.buttons, zone, linkUrl, bgMobile),
    ...
    if (editingId) {
      ...
      up.data.bg_image_url_mobile = packedUp.bg_image_url_mobile;
      return up.data;
    }
    ...
    ins.data.bg_image_url_mobile = packedIns.bg_image_url_mobile;
    return ins.data;
  }
