...
(function () {
  ...
  var PAGE_FALLBACK = {
    ...
    '/lease-transfers': {
      title: '리스 · 장기렌트 일반승계 | 퍼플오토',
      description: '리스·장기렌트 일반승계 매물을 한눈에 확인하세요. 국산차·수입차까지 가격·연식·주행거리로 검색할 수 있습니다.',
      meta_keywords: '리스승계,장기렌트승계,일반승계,리스승계매물,장기렌트승계매물,퍼플오토',
      og_title: '리스 · 장기렌트 일반승계 | 퍼플오토',
      og_description: '리스·장기렌트 일반승계 매물을 한눈에 확인하세요.',
      twitter_description: '리스·장기렌트 일반승계 매물을 한눈에 확인하세요.'
    },
    '/paid-transfer': {
      title: '완납승계 인수 · 판매 | 퍼플오토',
      description: '리스·장기렌트 완납승계 인수·판매 서비스. 승계대행, 비교견적, 방문검수까지 퍼플오토와 함께하세요.',
      meta_keywords: '완납승계,리스승계,장기렌트승계,승계매입,승계인수,퍼플오토',
      og_title: '완납승계 인수 · 판매 | 퍼플오토',
      og_description: '리스·장기렌트 완납승계 인수·판매 서비스. 승계대행, 비교견적, 방문검수까지 퍼플오토와 함께하세요.',
      twitter_description: '리스·장기렌트 완납승계 인수·판매 서비스.'
    },
    '/lease-transfer-detail': {
      title: '리스 · 장기렌트 일반승계 상세 | 퍼플오토',
      description: '퍼플오토 리스 · 장기렌트 일반승계 매물 상세 정보.',
      meta_keywords: '리스승계,장기렌트승계,일반승계,퍼플오토',
      og_title: '리스 · 장기렌트 일반승계 상세 | 퍼플오토',
      og_description: '퍼플오토 리스 · 장기렌트 일반승계 매물 상세 정보.',
      twitter_description: '퍼플오토 리스 · 장기렌트 일반승계 매물 상세 정보.'
    },
    '/used-cars': {
      title: '중고차 매물 | 퍼플오토',
